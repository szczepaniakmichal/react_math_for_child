...
`
    ...
    <Div padding={20} column>
        <Div column>
            <InputField title="how many tasks?" className="how-many-task" value={2}/>
            <InputField title="how many values to calculate?" className="how-many-value" value={2}/>
            <InputField title="maximum single value?" className="to-value" value={5}/>
        </Div>
        <Div column>
