...
import { calculateDoneTasks, createTasks } from "utils";
        ...
        <Suspense fallback="Loading...">
            <Div padding={20} column>
                ...
                <SectionWrapper column>
                    ...
                    <InputField title={t('howManyValuesToCalculate')} value={howManyValues}
                                onChange={handleHowManyValues} max={5} min={2}/>
